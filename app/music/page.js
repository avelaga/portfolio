...
export default function Music() {
    return <div className="page">
        ...
        <img src="/images/music/indulgent/indulgentlive.jpg" className="music-full" />
        ...
        <img src="/images/music/indulgent/guitar1.jpg" className="half-left" />
        <img src="/images/music/indulgent/guitar2.jpg" className="half-right" />
        ...
        <img src="/images/music/caladan/caladan.jpg" className="music-full" />
        ...
        <img src="/images/music/caladan/group.jpg" className="music-full" />
        ...
        <div className="section-subtitle">drums</div>
        <div className="section-year">2022 - 2023</div>
        <img src="/images/music/sd/sd1.jpg" className="music-full" />
        <img src="/images/music/sd/fallingKid.jpg" className="music-half" />
        <div className="music-video">
        ...
        <img src="/images/music/mjf/mjf.jpg" className="music-full" />
        ...
        <img src="/images/music/mjf/studio.jpg" className="music-full" />
        ...
        <div className="music-releases">
            <div className="music-release">
                <a href="https://open.spotify.com/album/097Hlqmh6mqEv6GJbxf61L?si=NO5UrK5mTlymBRe4vKErNw">
                    <img src="/images/music/mjf/cover.jpg" className="music-cover" />
                    Pulls You Under
                    <br />
                    2019
                </a>
