...
export default function Music() {
    return <div className="page">
        ...
        <img src="/images/music/indulgent/indulgentlive.jpg" alt="indulgent performing on stage" className="music-full" loading="lazy" />
        ...
        <img src="/images/music/indulgent/guitar1.jpg" alt="recording guitar in studio" className="half-left" loading="lazy" />
        <img src="/images/music/indulgent/guitar2.jpg" alt="recording guitar in studio 2" className="half-right" loading="lazy" />
        ...
        <img src="/images/music/caladan/caladan.jpg" alt="caladan performing live" className="music-full" loading="lazy" />
        ...
        <img src="/images/music/caladan/group.jpg" alt="caladan portrait" className="music-full" loading="lazy" />
        ...
        <div className="section-subtitle">drums</div>
        <div className="section-year">2022 - 2023</div>
        <img src="/images/music/sd/sd1.jpg" alt="shivering demons performing live" className="music-full" loading="lazy" />
        <img src="/images/music/sd/fallingKid.jpg" alt="shivering demons performing at house party" className="music-half" loading="lazy" />
        <div className="music-video">
        ...
        <img src="/images/music/mjf/mjf.jpg" alt="merry jane & the fondas portrait" className="music-full" loading="lazy" />
        ...
        <img src="/images/music/mjf/studio.jpg" alt="merry jane & the fondas recording with jackie venson" className="music-full" loading="lazy" />
        ...
        <div className="music-releases">
            <div className="music-release">
                <a href="https://open.spotify.com/album/097Hlqmh6mqEv6GJbxf61L?si=NO5UrK5mTlymBRe4vKErNw" target="blank">
                    <img src="/images/music/mjf/cover.jpg" className="music-cover" loading="lazy" alt="pulls you under album cover" />
                    Pulls You Under
                    <br />
                    2019
                </a>
