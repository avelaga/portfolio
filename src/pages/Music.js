...
export default function Music() {
    return <div className="page">
        ...
        <div className="section-title">INDULGENT</div>
        ...
        <img src={guitar1} className="music-half" />
        <img src={guitar2} className="music-half" />
        ...
        <div className="section-title">CALADAN</div>
        ...
        <div className="music-video">
            <YouTube videoId="VQsZdVG8A8I" className="youtube-half" />
            hole in the wall <br />
            1.7.23
        </div>
        <div className="music-video">
            <YouTube videoId="hQgL_IebL_s" className="youtube-half" />
            woodshed <br /> 12.17.22
        </div>
        <img src={caladanGroup} className="music-half" />

        <div className="line" />

        <div className="section-title">SHIVERING DEMONS</div>
        <div className="section-subtitle">drums</div>
        ...
        <div className="music-video">
            <YouTube videoId="08FnNPD-Eng" className="youtube-half" />
            11.11.22 <br /> rio market
        </div>
        <div className="music-video">
            <YouTube videoId="6mEqHssj27Y" className="youtube-half" />
            pearl st. co-op <br /> 10.28.22
        </div>

        <div className="line" />

        <div className="section-title">MERRY JANE & THE FONDAS</div>
        <div className="section-subtitle">drums</div>
